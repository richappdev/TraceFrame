...
export const copy = {
  "zh-CN": {
    site: {
      ...
      discover: "发现", library: "我的收藏", trips: "我的行程", policy: "数据政策", plan: "从收藏规划",
    ...
    home: {
      ...
      start: "从收藏规划", browse: "浏览巡礼索引", planHelper: "登录后同步收藏，选择作品并生成 1–3 天行程。", feature1: "天轻行程", feature2: "城市优先", feature3: "安心分享",
    ...
    library: {
      ...
      mappedOnly: "仅看已映射", plan: "规划行程", continuePlan: "选择作品", planStep: "从收藏规划 · 第 1 步（共 3 步）", syncThenPlan: "同步完成后将直接进入作品选择；如已同步，可立即继续。", myTrips: "我的行程", logout: "退出",
  ...
  "zh-TW": {
    site: {
      ...
      home: "AniPins 首頁", tagline: "聖地巡禮手帖", nav: "主要導覽", discover: "探索", library: "我的收藏", trips: "我的行程", policy: "資料政策", plan: "從收藏規劃",
    ...
    home: {
      ...
      start: "從收藏規劃", browse: "瀏覽聖地巡禮索引", planHelper: "登入後同步收藏，選擇作品並產生 1–3 天行程。", feature1: "天輕旅行", feature2: "城市優先", feature3: "安心分享", example: "東京兩日聖地巡禮範例", exampleTitle: "東京座標散步", stepTitle: "從收藏到出發，只差三步。",
    ...
    library: { title: "我的收藏", loginIntro: "登入 Bangumi 後，可查看收藏中的作品是否有 Anitabi 聖地巡禮地圖。", publicIndex: "先瀏覽公開 Presence 索引", possessive: "的收藏", sync: "同步收藏", showAll: "顯示全部", mappedOnly: "只看已對應", plan: "規劃行程", continuePlan: "選擇作品", planStep: "從收藏規劃 · 第 1 步（共 3 步）", syncThenPlan: "同步完成後將直接進入作品選擇；若已同步，可立即繼續。", myTrips: "我的行程", logout: "登出", empty: "目前沒有條目。請先同步收藏，或關閉「只看已對應」篩選。", clickSync: "點選同步，從 Bangumi 取得收藏", wish: "想看", collect: "看過", do: "在看", on_hold: "擱置", dropped: "放棄" },
  ...
  "ja-JP": {
    site: { title: "AniPins — アニメ聖地巡礼プランナー", description: "BangumiのコレクションからAnitabiの聖地巡礼マップを見つけ、1〜3日間の旅程を作成します。", home: "AniPins ホーム", tagline: "聖地巡礼手帖", nav: "メインナビゲーション", discover: "見つける", library: "マイコレクション", trips: "自分の旅程", policy: "データポリシー", plan: "コレクションから作る", footer: "好きな物語を、現実の旅へ。", privacy: "プライバシーとデータ削除", license: "データとライセンス", contact: "お問い合わせ", language: "言語" },
    ...
    home: { eyebrow: "旅立つ前のピン", title1: "好きな物語を、", title2: "現実の旅へ。", lede: "BangumiのコレクションからAnitabiに登録済みの作品を探し、点在する舞台を分かりやすく共有できる都市別の旅程にまとめます。", start: "コレクションから作る", browse: "聖地巡礼インデックス", planHelper: "ログイン後にコレクションを同期し、作品を選んで1〜3日の旅程を作成します。", feature1: "日の小旅行", feature2: "都市を優先", feature3: "安心して共有", example: "東京2日間の例", exampleTitle: "東京ロケ地散歩", stepTitle: "コレクションから出発まで、3ステップ。", stepIntro: "地図を複製せず、旅を勝手に決めることもありません。AniPinsは作品、都市、ルートの手がかりを使いやすく整理します。", steps: [["コレクションを連携", "Bangumiでログインし、見たい作品を聖地巡礼の候補にします。"], ["舞台を確認", "Anitabiで確認済みの情報と照合し、実際に訪ねられる作品を都市別に探します。"], ["旅程にまとめる", "1〜3日を選び、都市別にまとめた作品の順番を調整して同行者と共有します。"]], explore: "まずは一つの都市、一つの作品から。", openIndex: "都市インデックスを開く" },
    ...
    library: { title: "マイコレクション", loginIntro: "Bangumiでログインすると、コレクション内でAnitabiの聖地巡礼マップに対応している作品を確認できます。", publicIndex: "公開Presenceインデックスを見る", possessive: "のコレクション", sync: "コレクションを同期", showAll: "すべて表示", mappedOnly: "対応作品のみ", plan: "旅程を作る", continuePlan: "作品を選ぶ", planStep: "コレクションから作る · ステップ1/3", syncThenPlan: "同期後は作品選択へ進みます。同期済みの場合はすぐに続けられます。", myTrips: "自分の旅程", logout: "ログアウト", empty: "作品がありません。コレクションを同期するか、「対応作品のみ」を解除してください。", clickSync: "同期してBangumiからコレクションを取得", wish: "見たい", collect: "見た", do: "見てる", on_hold: "保留", dropped: "中断" },
