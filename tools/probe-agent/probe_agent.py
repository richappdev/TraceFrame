...
# Canonical reconciled registry from valid-ids.csv (2026-07-20).
SEED_SUBJECT_IDS = [
    247, 265, 311, 321, 324, 326, 876, 1270, 1424, 1608, 3375, 4019, 9717,
    10380, 22759, 25961, 93739, 110467, 115908, 207195, 211567, 216371,
    240038, 240562, 269235, 328609, 333158, 364450, 378862, 428735, 431767,
]
